    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <div className="bg-slate-900 text-white py-20 px-6 text-center shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <span className="text-amber-500 tracking-[0.3em] font-bold uppercase text-xs mb-4 block">
            The Collection
          </span>
          <h1 className="text-4xl md:text-6xl font-serif mb-6 drop-shadow-md">
            Find Your Sanctuary
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto font-light text-lg">
            Browse our exclusive selection of suites and villas designed for the ultimate sophisticated retreat.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-72 bg-white p-8 border border-slate-200 shadow-sm h-fit">
          ...
          <div className="space-y-8">
            <div>
              <label className="text-xs font-bold uppercase tracking-[0.2em] text-slate-900 block mb-3">
                Accommodation Type
              </label>
              <select className="w-full bg-slate-50 border border-slate-200 text-sm p-4 outline-none focus:ring-1 focus:ring-amber-500">
            ...
            <div>
              ...
              <input type="range" className="w-full h-1 bg-slate-200 rounded-lg cursor-pointer accent-amber-500" />
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {rooms.length > 0 ? (
                ...
                <div className="col-span-full text-center py-20 bg-white border">
